...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BY5ST29I.mjs");
...
var manifest = {
	"765352e0f4f77ddb5d4fc18684af604e0147edca87f90f6f1a5dccbda48f2dc5": {
		functionName: "recordConsent_createServerFn_handler",
		importer: () => import("./commerce-CQ7oADyH.mjs")
	},
	"92aadbe6a3179c6facf458234b3f9c5fc0644919ab624f5106ffd4fdd87cff9b": {
		functionName: "createWhatsAppCheckout_createServerFn_handler",
		importer: () => import("./commerce-CQ7oADyH.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CT1xTNGo.mjs").then((n) => n.t),

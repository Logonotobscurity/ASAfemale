...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CyiU1cGE.js
...
var styles_default = "/assets/styles-mJwQLXNS.css";
var APP_NAME = "ÀṢÀ — WOMENSWEAR DROPS";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "ÀṢÀ womenswear drops from Lagos. Skirts, trousers, mamiwata gowns and tennis skirts — every drop texted first."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-CeTIFYMO.mjs");
